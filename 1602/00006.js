...
function konversiMenit(menit) {
  ...
  //Membagi jam kedalam menit
  var jam = Math.floor(menit/60);
  //Menghitung sisa bmenit
  var sisaMenit = menit%60;

  //menjadikan menit kedalam bentuk string dan menjadikannya angka kedua setelah 0
  var menit =sisaMenit.toString().padStart(2,'0');
